...
> Empty on purpose. This file is written at Gate 1, after the brief is frozen.
> See `docs/building-a-game.md` §0 Step 3B.
...
Every file in `games/snake/src/`, what it owns, and whether it is pure. The
...
| --- | --- | --- | --- |
| T1 | Scaffold from `games/2048/` | `pnpm --filter @game/snake dev` serves a blank board at `/g/snake/` | — |
...
| T8 | PWA: manifest, icon, SW at `/g/snake/` | installs on Android, plays offline | T3 |
